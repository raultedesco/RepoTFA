...
//--AgentGen END
  ...
  // Scalars
  private MOScalar nlmConfigGlobalEntryLimit;
  private MOScalar nlmConfigGlobalAgeOut;
  private MOScalar nlmStatsGlobalNotificationsLogged;
  private MOScalar nlmStatsGlobalNotificationsBumped;
  ...
  private MOTable      nlmConfigLogEntry;
  private MOTableModel nlmConfigLogEntryModel;
  ...
  // Column sub-identifer definitions for nlmStatsLogEntry:
  ...
  private MOTable      nlmStatsLogEntry;
  private MOTableModel nlmStatsLogEntryModel;
  ...
  private MOTable      nlmLogEntry;
  private MOTableModel nlmLogEntryModel;
  ...
  private MOTable      nlmLogVariableEntry;
  private MOTableModel nlmLogVariableEntryModel;
...
//--AgentGen BEGIN=_MEMBERS
  ...
  private MOTableRelation nlmStatsLogEntryAugmentation;
  private List<OID> nlmLogEntries = new ArrayList<OID>();

  private MOScalar snmp4jNotificationLogMode;
...
//--AgentGen BEGIN=_CONSTRUCTORS
  public NotificationLogMib(MOFactory moFactory, VACM vacm,
    ...
    this.nlmStatsLogEntryAugmentation =
        new MOTableRelation(nlmConfigLogEntry, nlmStatsLogEntry);
...
//--AgentGen END
  ...
  private void createNlmConfigLogEntry(MOFactory moFactory) {
    ...
    ((MOMutableTableModel)nlmConfigLogEntryModel).setRowFactory(
  ...
  private void createNlmStatsLogEntry(MOFactory moFactory) {
    ...
    ((MOMutableTableModel)nlmStatsLogEntryModel).setRowFactory(
...
,
    ...
    nlmLogEntryModel =
      moFactory.createTableModel(oidNlmLogEntry,
                                 nlmLogEntryIndex,
                                 nlmLogEntryColumns);
    ((MOMutableTableModel)nlmLogEntryModel).setRowFactory(
...
,
    ...
    ((MOMutableTableModel)nlmLogVariableEntryModel).setRowFactory(
...
//--AgentGen END
  ...
  // Scalars
  public class NlmConfigGlobalEntryLimit extends MOScalar {
...
//--AgentGen END
  ...
  public class NlmConfigGlobalAgeOut extends MOScalar {
...
//--AgentGen END
  ...
  class NlmConfigLogEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<NlmConfigLogEntryRow>
  {
  ...
  class NlmStatsLogEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<NlmStatsLogEntryRow>
  {
  ...
  class NlmLogEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<NlmLogEntryRow>
  {
  ...
  class NlmLogVariableEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<NlmLogVariableEntryRow>
  {
...
//--AgentGen BEGIN=_METHODS
  ...
  public void notificationLogEvent(NotificationLogEvent notificationLogEvent) {
    if (notificationLogEvent.isSubEvent() ==
      ...
      synchronized (nlmConfigLogEntryModel) {
        for (Iterator<MOTableRow> it = nlmConfigLogEntryModel.iterator(); it.hasNext(); ) {
  ...
  private void checkLimits(OctetString profileName) {
    ...
    if (ageOut > 0) {
      ...
      synchronized (nlmLogEntryModel) {
        ...
        for (Iterator<MOTableRow> it = nlmLogEntryModel.iterator(); it.hasNext(); ) {
  ...
  private boolean addVariable(OID logIndex, int varIndex, VariableBinding vb) {
    ...
    MOTableRow row = nlmLogVariableEntry.createRow(vIndex,variables);
