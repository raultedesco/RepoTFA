...
//--AgentGen END
  ...
  private MOTable      snmpTlstmCertToTSNEntry;
...
//--AgentGen END
  ...
  private void createSnmpTlstmCertToTSNEntry(MOFactory moFactory) {
    ...
    snmpTlstmCertToTSNEntryModel =
        (DefaultMOMutableTableModel<SnmpTlstmCertToTSNEntryRow>)
        moFactory.createTableModel(oidSnmpTlstmCertToTSNEntry,
                                   snmpTlstmCertToTSNEntryIndex,
                                   snmpTlstmCertToTSNEntryColumns);
    ((MOMutableTableModel)snmpTlstmCertToTSNEntryModel).setRowFactory(
      new SnmpTlstmCertToTSNEntryRowFactory());
...
//--AgentGen END
  ...
  class SnmpTlstmCertToTSNEntryRowFactory 
        extends DefaultMOMutableRow2PCFactory<SnmpTlstmCertToTSNEntryRow>
  {
  ...
  class SnmpTlstmParamsEntryRowFactory 
        extends DefaultMOMutableRow2PCFactory<SnmpTlstmParamsEntryRow>
  {
  ...
  class SnmpTlstmAddrEntryRowFactory 
        extends DefaultMOMutableRow2PCFactory<SnmpTlstmAddrEntryRow>
  {
