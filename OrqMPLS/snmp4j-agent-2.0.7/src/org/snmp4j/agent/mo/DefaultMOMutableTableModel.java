    ...
    implements MOMutableTableModel<R>
{
  ...
  public synchronized List<MOTableRow> getRows(OID lowerBound, OID upperBoundEx) {
    List<MOTableRow> view = new ArrayList<MOTableRow>(getView(lowerBound, upperBoundEx).values());
    return view;
  }
   ...
   *    an Iterator.
   */
  public synchronized Iterator<R> iterator(MOTableRowFilter filter) {
