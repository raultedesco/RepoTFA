...
//--AgentGen END
  ...
  public class AgentppSimDeleteRow extends MOScalar {
...
//--AgentGen END
  ...
  public class AgentppSimDeleteTableContents extends MOScalar {
...
//--AgentGen BEGIN=_METHODS
  private synchronized ManagedObject getManagedObject(OID oid) {
    ...
    ManagedObject mo = AgentppSimulationMib.this.moServer.lookup(query);
    return mo;
  }
//--AgentGen END
