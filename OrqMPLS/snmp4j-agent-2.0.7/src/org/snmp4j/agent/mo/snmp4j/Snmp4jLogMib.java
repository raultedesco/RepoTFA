...
//--AgentGen END
  ...
  class Snmp4jLogLoggerEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<Snmp4jLogLoggerEntryRow>
  {
...
//      Snmp4jLogLoggerEntryRow row = new Snmp4jLogLoggerEntryRow(index, values);
  ...
  class Snmp4jLogLoggerToHandlerEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<Snmp4jLogLoggerToHandlerEntryRow>
  {
  ...
  class Snmp4jLogHandlerEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<Snmp4jLogHandlerEntryRow>
  {
  ...
  class Snmp4jLogFileHandlerEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<Snmp4jLogFileHandlerEntryRow>
  {
  ...
  class Snmp4jLogConsoleHandlerEntryRowFactory
        extends DefaultMOMutableRow2PCFactory<Snmp4jLogConsoleHandlerEntryRow>
  {
