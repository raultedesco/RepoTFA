...
public class CommandProcessor
  ...
  protected final Vector<RequestHandler> pduHandler = new Vector<RequestHandler>();
  protected TemporaryList<Request> requestList;
  protected RequestFactory<CommandResponderEvent> requestFactory;
  ...
  class VACMQuery extends MOQueryWithSource {
    ...
    public VACMQuery(OctetString context,
                     ...
                     Request<CommandResponderEvent,PDU> source) {
      super(new DefaultMOContextScope(context,
                                      lowerBound, isLowerIncluded,
                                      upperBound, isUpperIncluded),
  ...
  static class DefaultRequestFactory implements RequestFactory<CommandResponderEvent> {
    public Request createRequest(CommandResponderEvent initiatingEvent,
                                 CoexistenceInfo cinfo) {
